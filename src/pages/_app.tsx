  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Happy Notes is a feature-rich note-taking application built with Next.js, React, Framer Motion, Tailwind CSS, and Redux. It is also integrated with Progressive Web App (PWA) technology.
