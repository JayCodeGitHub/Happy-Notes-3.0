...
export default function Site({ title, url }: SiteProps) {
  ...
  return (
    <motion.div
      className="p-2 overflow-hidden text-center transition-all rounded-md dark:bg-gray-700 bg-slate-200"
      layout
    ...
    >
      <h1 className="text-xl text-gray-900 transition-all dark:text-white">
        {title}
      </h1>
